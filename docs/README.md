...
This directory contains repository-local App Core documentation.

## Current Local Docs

- [`address-components.md`](address-components.md) - address display and input primitives plus current adoption points.
